...
set output "recovery/plots/drift10_m200.png"

set xrange [50:50+200]
set xtics 0,25
#set log y
...
plot\
	...
	'recovery/values/200/stmvl200.txt' index 0 using 1:2 title 'stmvl' with linespoints lt 8 dt 2 lw 3 pt 8 lc rgbcolor "green" pointsize 1.2, \
