set terminal png size 12*600,720
set output "recovery/plots/drift10_m600.png"

set xrange [50:50+600]
set xtics 0,25
#set log y
...
plot\
	...
	'recovery/values/600/stmvl600.txt' index 0 using 1:2 title 'stmvl' with linespoints lt 8 dt 2 lw 3 pt 8 lc rgbcolor "green" pointsize 1.2, \
